 ...
 * @str: string
 * Return: length len of string Success
 */
int find_len(char *str)
{
	int len = 0;
 ...
 * @size: size of array
 * Description: function exits with a status of 98
 * Return: pointer to the array Success, NULL fails
 */
char *create_xarray(int size)
{
	char *array;
 ...
 * @c: character
 * Description: If c is a non-digit, the functio exits with a status of 98
 ...
 * Description: mult contains a non-digit, exits with a status value of 98
 */
void get_prod(char *prod, char *mult, int digit, int zeroes)
{
